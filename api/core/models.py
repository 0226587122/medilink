...
class Medication(models.Model):
    ...
    name = models.CharField(max_length=120)
    dose = models.CharField(max_length=60)   # e.g., 5 mg
    form = models.CharField(max_length=60, blank=True)  # tablet, capsule
    frequency = models.CharField(max_length=60)  # e.g., 2x/day
    time_of_day = models.CharField(max_length=20, blank=True)  # morning/evening
